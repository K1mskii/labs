...
$result = mysqli_query($db,"SELECT * FROM users WHERE login='$login'"); //извлекаем из базы все данные о пользователе с введенным логином
   ...
   // echo '<img class="shop__img" src="'.$uploadfile.'">';
    echo '<input type="button" name="" class="header__button" value = "'.$_SESSION["login"].'" id="auth">';
   // echo '<input type=button class="header__button" value="'.$login.'"></input>';
    }
 else {
